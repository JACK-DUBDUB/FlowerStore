    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                new Product { Id = 1, CategoryId = 1, Name = "Acanthus", StoreLocation = "Canning Vale", PostCode=6155, Price = 68, IsAvailable = true },
                ...
                new Product { Id = 5, CategoryId = 1, Name = "Chrisantemum", StoreLocation = "Cannington", PostCode=6112, Price = 60, IsAvailable = true },
                ...
                new Product { Id = 12, CategoryId = 2, Name = "Gladiolus", StoreLocation = "Joondanna", PostCode=6117, Price = 68, IsAvailable = true },
                new Product { Id = 13, CategoryId = 2, Name = "Geranium Large", StoreLocation = "Joondalup", PostCode=6112, Price = 125, IsAvailable = true },
                new Product { Id = 14, CategoryId = 2, Name = "Sunflower", StoreLocation = "Geralton", PostCode=6118, Price = 55, IsAvailable = true },
                ...
                new Product { Id = 18, CategoryId = 3, Name = "Azalea", StoreLocation = "Mundijong", PostCode=6123, Price = 2.8M, IsAvailable = true },
                ...
                new Product { Id = 21, CategoryId = 3, Name = "Peach Zinnia", StoreLocation = "North Fremantle", PostCode=6126, Price = 2.8M, IsAvailable = true },
                ...
                new Product { Id = 24, CategoryId = 4, Name = "Petunia", StoreLocation = "South Fremantle", PostCode=6129, Price = 24.99M, IsAvailable = true },
                new Product { Id = 25, CategoryId = 5, Name = "Dahlia (long lasting)", StoreLocation = "Perth City", PostCode=6112, Price = 9.99M, IsAvailable = true },
                ...
                new Product { Id = 29, CategoryId = 5, Name = "Marigold", StoreLocation = "Carlisle", PostCode=6133, Price = 9.99M, IsAvailable = true },
                ...
                new Product { Id = 33, CategoryId = 5, Name = "Calla Lily", StoreLocation = "Rockingham", PostCode=6001, Price = 12.49M, IsAvailable = true });
        }
    }
}
